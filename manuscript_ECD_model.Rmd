...
All simulations were conducted in R [@R] and the code to reproduce these simulations is publically available on GitHub (https://github.com/mabarbour/ECD_model) and has been archived with Zenodo (https://zenodo.org/badge/latestdoi/79349192).
