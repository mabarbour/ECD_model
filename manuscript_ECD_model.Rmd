...
However, whenever consumers were mobile and competed for resources that occured in distinct habitats, character displacement suppressed resource densities and resulted in less stable food webs. 
...
- Divergent character displacement may be quite common in systems with animal consumers (and thus biological resources). This means there are many situations where consumers couple resources in distinct habitats. Draw on sticklebacks as an example.

- Overrepresentation of carnivores (and even including herbivores) in this Schluter 2000.
...
<!-- Food-web stability
- Our most striking result is that character displacement, under foraging scenarios that capture the biology of many consumers, could result in unstable food webs. This contrasts the notion from coexistence theory that character displacement contributes to species persistence. My results do not contradict these past inferences, as they were based on different measures of stability. However, its clear that stability measures do not always go hand-in-hand and that a pluralistic view of different aspects of stability is needed for understanding the eco-evolutionary effect on food-web dynamics.
- In line with past theory, we found that food-web stability tended to go hand-in-hand with resource densities. 
- Drawing on the theory I developed, I can point to situations where we would expect character displacement to results in less stable food webs. 
    - Consumers foraging in distinct habitats, concave up tradeoff in attack rates, and in aquatic systems. Aquatic systems are more likely because its been shown that attack rates are often much stronger in these systems. This lower baseline, means that it is easier for character displacement to push these systems toward the boundary of local stability.
    - Interestingly, the study system that remains the hallmark of character displacement, threespine stickleback, meets all of these criteria. Thus, I predict that in the coastal lakes of British Columbia, where stickleback have undergone character displacement, for these food webs to exhibit less stable dynamics and more variable population abundances. 
    - Although stability is a traditionally thorny issue to measure.
--


<!-- Caveats -->

Our model assumes symmetry in displacement which is not uncommon in empirical data [@Schluter2000].
...
The content of this paper was greatly enhanced by numerous conversations with Seth Rudman. Sally Otto provided much help in early analyses of the mathematical model and I would not have been able to take the theory as far as I did without her guidance and encouragement. A discussion with Ben Gilbert pushed me to take a comparative approach that looked across different foraging scenarios to examine the generality of my conclusions.
