...
params_2C_2R_LawlorSmith_linear_asymm[c("a21","a22")] <- sim_1C_2R_LawlorSmith_linear[nrow(sim_1C_2R_LawlorSmith_linear), c("a11","a12")] 
...
params_2C_2R_LawlorSmith_concaveDN_asymm[c("a21","a22")] <- sim_1C_2R_LawlorSmith_concaveDN[nrow(sim_1C_2R_LawlorSmith_concaveDN), c("a11","a12")] 
...
params_2C_2R_LawlorSmith_concaveUP_asymm[c("a21","a22")] <- sim_1C_2R_LawlorSmith_concaveUP[nrow(sim_1C_2R_LawlorSmith_concaveUP), c("a11","a12")] 
...
params_2C_2R_McCann_linear_asymm[c("a21","a22")] <- sim_1C_2R_McCann_linear[nrow(sim_1C_2R_McCann_linear), c("a11","a12")] 
...
params_1C_2R_McCann_linear_alt_w <- params_1C_2R_McCann_linear # NEED TO FIGURE OUT WHAT TO DO. i SHOULD PROBABLY MAKE SURE ATTACK RATES AND PREFERENCE ARE ALIGNED, BUT I SHOULD JUST DO THAT FOR THE ALTERNATIVE RESOURCE. E.G. C1 SPECIALIZING ON R2 INSTEAD OF R1 IN THE C1 ONLY SIMS.
sim_1C_2R_McCann_linear <- eco_evo_CR(init_parameters = params_1C_2R_McCann_linear_alt_w, 
                                         init_states = states_1C_2R, 
                                         eco_CR_model = McCann_1C_2R, 
                                         AD_CR_models = c(mC1_McCann),
                                         species_traits = c(1), 
...
params_2C_2R_McCann_concaveDN_asymm[c("a21","a22")] <- sim_1C_2R_McCann_concaveDN[nrow(sim_1C_2R_McCann_concaveDN), c("a11","a12")] 
...
params_2C_2R_McCann_concaveUP_asymm[c("a21","a22")] <- sim_1C_2R_McCann_concaveUP[nrow(sim_1C_2R_McCann_concaveUP), c("a11","a12")] 
