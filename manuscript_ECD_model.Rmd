...
bibliography: ReferencesAbbrev.bib
biblio-style: amnat
fontsize: 11pt
fontfamily: mathpazo
...
*Data accessibility*: No new data were used. All code used to reproduce this manuscript and simulations within are publically available on GitHub (https://github.com/mabarbour/ECD_model) and has been archived with Zenodo (https://zenodo.org/badge/latestdoi/79349192).
