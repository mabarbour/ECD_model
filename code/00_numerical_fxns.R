...
ECD_model <- function(Time,State,Pars) {
...
ECD_model.C1.3sp <- function(Time,State,Pars) {
  # t,y,p is the necessary format for solving using the ode() function in R
  with(as.list(c(State,Pars)), {
    # constraints on consumer preference
    w12 <- (1 - w11)
...
ECD_model.C2.3sp <- function(Time,State,Pars) {
  # t,y,p is the necessary format for solving using the ode() function in R
  with(as.list(c(State,Pars)), {
    # constraints on consumer preference
    #w12 <- (1 - w11)
...
mut_ECD_model <- function(Time,State,Pars) {
  # t,y,p is the necessary format for solving using the ode() function in R
  with(as.list(c(State,Pars)), {
    # constraints on consumer preference
    w12 <- (1 - w11)
...
mutC1_ECD_model <- function(Time,State,Pars) {
  # t,y,p is the necessary format for solving using the ode() function in R
  with(as.list(c(State,Pars)), {
    # constraints on consumer preference
    w12 <- (1 - w11)
...
mutC2_ECD_model <- function(Time,State,Pars) {
  # t,y,p is the necessary format for solving using the ode() function in R
  with(as.list(c(State,Pars)), {
    # constraints on consumer preference
    w12 <- (1 - w11)
...
mut_ECD_model.C1.3sp <- function(Time,State,Pars) {
  # t,y,p is the necessary format for solving using the ode() function in R
  with(as.list(c(State,Pars)), {
    # constraints on consumer preference
    w12 <- (1 - w11)
...
mut_ECD_model.C2.3sp <- function(Time,State,Pars) {
  # t,y,p is the necessary format for solving using the ode() function in R
  with(as.list(c(State,Pars)), {
    # constraints on consumer preference
    #w12 <- (1 - w11)
